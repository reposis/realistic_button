...
class RealisticButton extends StatefulWidget {
  final double size;
  ...
  @override
  State<RealisticButton> createState() => _RealisticButtonState();
}

class _RealisticButtonState extends State<RealisticButton>
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    width: widget.size / 10, color: const Color(0xff393b3b)),
